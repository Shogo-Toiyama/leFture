...
const kTutorialContentJa = TutorialContent(
  ...
  announcements: [
    TutorialAnnouncement(
      id: 'ann_1',
      type: 'TODO',
      content: 'プロフィール（専攻・興味・将来の夢）を埋めて、自分だけのパーソナライズ雑学を体験しよう！',
    ),
    TutorialAnnouncement(
      id: 'ann_2',
      type: 'TODO',
...
授業で習う内容の中で、大切じゃないものなんてありません。そしてほとんどの人は自分の興味のある分野を専攻として選んでいると思います。つまりたいていの授業内容は日常生活で大切なものか、もしくは自分の興味につながっている可能性が高いはずです。ただし、学校では一人一人の事情に合わせて面白く授業をすることなんてできません。だからこそ、授業で習わないような面白い雑学を自分だけにパーソナライズして生み出せれば、その授業内容がもっと面白くなるんじゃないかと思ったのです。

## ⚙️ 解決のための「ポジティブなルーティーン」
これらを解決するために、AIを使って授業内容を分析し、楽しく簡単にしっかり復習ができる教材と、一人一人に合わせた雑学を生成する、そんなアプリを作ろうと思い立ちました。操作はとても簡単です。

- 授業が始まる前に**録音ボタン**を1回押す
- 授業中はスマホを触らず、ただ**授業に集中する**
- 授業が終わったら**音声をアップロードする**だけ

これだけで、10分程度で復習教材と雑学、そしてさまざまな学習をしやすくするためのコンテンツが生成されます。帰りのバスでも、家のソファでも、リラックスできる環境でサッと復習ができ、また明日からの授業が楽しみになる、そんなポジティブなルーティーンが生まれることを願っています。''',
      reviewCards: [
        TutorialReviewCard(
          cardType: 'hook',
          heroEmoji: '❓',
        ...
        TutorialReviewCard(
          ...
          contentBlocks: [
            {
              'type': 'paragraph',
              'text': 'アップロードから約10分。AIが音声を解析し、ノイズを削ぎ落として高品質な復習コンテンツと雑学を自動生成します。',
            },
            {
              'type': 'callout',
              'alert_type': 'warning',
            ...
            {
              'type': 'paragraph',
              'text': 'この10分の裏側では、文字起こし→トピック分割→要約→復習カード生成→雑学生成という複数のAIタスクが、順番に、時には並行して走っています。処理が終わると**プッシュ通知**が届くので、気づいたときにはもう復習の準備が整っています。',
            },
          ],
        ),
        TutorialReviewCard(
...
授業後に明確にわかりやすい復習教材が準備されていれば、復習のハードルが一つ減ります。授業終わりには復習カードでさらっと復習し、しっかり勉強したい時に詳細ノートを読み込む、そうすれば次の授業も、そしてテストも、自信を持って受けに行くことができるようになるのではないでしょうか。''',
      reviewCards: [
        ...
        TutorialReviewCard(
          ...
          contentBlocks: [
            ...
            {
              'type': 'paragraph',
              'text': '次は、勉強を圧倒的に面白くする「雑学」セクションの秘密へ進みましょう！',
            },
          ],
        ),
      ],
    ...
    TutorialTopic(
      topicIndex: 3,
      title: '自分自身との繋がり',
      summary: 'プロフィール連携とリアルタイムWeb検索が生み出す、あなた専用のパーソナライズ雑学。',
...
脳は、単なる記号よりも「感情が動いた雑学」や「自分に関係があること」のほうが圧倒的に覚えやすく、そして楽しいと感じやすいのです。

その感覚を毎授業味わいたいと思って作ったのが「**雑学**」セクションです。作り方はシンプルで、以下の3つの情報を組み合わせています。
      ...
      reviewCards: [
        TutorialReviewCard(
          ...
          contentBlocks: [
            ...
            {
              'type': 'paragraph',
              'text': '人間の脳は、無機質な記号よりも「感情が動いた雑学」や「自分に関係があること」を圧倒的に覚えやすくできています。',
            },
            {
              'type': 'paragraph',
              'text': 'だったら、その「感情が動く瞬間」を毎回の授業で意図的に作ってしまえばいいんじゃないか——それがこの「**雑学**」セクションが生まれたきっかけです。',
            },
          ],
        ),
        TutorialReviewCard(
...
これまで復習と雑学の二つの機能について紹介しましたが、leFtureには他にも、学習に役立つ機能があります。
      ...
      reviewCards: [
        TutorialReviewCard(
          ...
          contentBlocks: [
            ...
            {
              'type': 'paragraph',
              'text': 'ここまで紹介してきた復習カード・詳細ノート・雑学は、実はこのアプリが目指す大きな未来の**ほんの入り口**に過ぎません。',
            },
          ],
        ),
        TutorialReviewCard(
