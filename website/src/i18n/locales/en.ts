...
export const en: Translations = {
  ...
  downloadModal: {
    ...
    androidDesc: 'Closed beta is currently underway. Register to get early access.',
    androidBadge: 'Closed Beta',
    note: '* Testing on iOS requires TestFlight; Android testing requires prior Google Play tester registration.',
    form: {
      back: 'Back',
      title: 'Join Android Closed Beta',
      subtitle: 'To join the Google Play closed test, your Google account must be registered in our tester list. We will send you the access link once added.',
      emailLabel: 'Google Account Email',
      emailPlaceholder: 'your.name@gmail.com',
      emailHint: '* Please enter the email address used for your Google Play Store account.',
      nameLabel: 'Name / Nickname (Optional)',
      namePlaceholder: 'Your name',
      deviceLabel: 'Device Model (Optional)',
      devicePlaceholder: 'e.g. Pixel 8, Galaxy S24, Xperia',
      submitButton: 'Apply for Closed Beta',
      submitting: 'Submitting...',
      successTitle: 'Application Submitted!',
      successMessage: 'Thank you for your interest! We will register your email on Google Play Console and email you the download link shortly.',
      closeButton: 'Done',
      errorEmail: 'Please enter a valid email address.',
      errorGeneric: 'An error occurred while submitting. Please try again later.',
    },
  },
  home: {
    hero: {
